...
namespace Data
{
    ...
    public static class ModelBuilderExtensions
    {
        ...
        /// <returns></returns>
        public static ModelBuilder ApplyAllConfigurations(this ModelBuilder modelBuilder, Type type, AppContext context = null)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public static ModelBuilder ApplyAllConfigurations(this ModelBuilder modelBuilder, Assembly assembly, AppContext context = null)
        {
            ...
            foreach (var config in configurations)
            {
                ...
                {
                    var includeContext = config.GetConstructors().Any(c => c.GetParameters().Any(p => p.ParameterType == typeof(AppContext)));
        ...
        /// <summary>
        /// Use the value convert specified for the type.
        /// </summary>
